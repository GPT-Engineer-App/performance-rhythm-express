      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <p>Cats are known for their independent nature and unique behaviors. They communicate through vocalizations, body language, and scent marking. Cats are also natural hunters and enjoy play that mimics hunting behaviors.</p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-2">
                ...
                <li className="flex items-center gap-2">
                  <Badge variant="outline">Tip</Badge>
                  Offer mental stimulation through toys and play.
                </li>
                <li className="flex items-center gap-2">
                  <Badge variant="outline">Tip</Badge>
        ...
        <div className="mt-8 text-center">
          <img src="https://placekitten.com/800/400" alt="Cute cat" className="rounded-lg shadow-lg mx-auto object-cover" />
        </div>
      </div>
    </div>
  );
